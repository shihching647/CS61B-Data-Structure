package laboratory.lab6;/* BankApp.java */
...
public class BankApp {
  ...
  private static VirtualTeller ATM = new VirtualTeller();
    ...
    try{
        ...
        while (!command.equals("quit")) {
            try {
                ...
                //To prevent infinite loop caused by empty account list
                if(ATM.getAccountCount() == 0) {
                    command = bankApp.readLine("--> ");
                }
            } catch(IOException e) {
