package laboratory.lab6;/* AccountData.java */

import laboratory.lab6.sortedlist.*;
...
public class AccountData implements Keyable {
  ...
  public void withdraw(int amt) throws BadTransactionException{
    if(amt < 0) {
      throw new BadTransactionException("Tried to withdraw less than 0: " + amt);
    } else if (amt <= balance) {
      balance = balance - amt;
    } else {
      throw new BadTransactionException("Insufficient funds:" + amt);
    }
  }
  ...
  public void deposit(int amt) throws BadTransactionException{
    if (amt >= 0) {
      ...
      throw new BadTransactionException("Tried to deposit less than 0: " + amt);
    }
  }
