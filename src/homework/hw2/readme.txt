...
------------------------
Change (cd) to your homework.hw2 directory, which should contain Date.java.  Make sure
your code compiles and your tests run correctly on the lab machines just before
you submit it.  From your homework.hw2 directory, type "submit homework.hw2".
